          ...
          {userType === 'customer' ? (
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <p><strong>2.2 Location:</strong> Some services or offers may only be available in specific countries or regions
                ...
                an account or placing orders. MyPlug reserves the right to suspend or delete accounts with
                fraudulent or misleading information.</p>

              <h3 className="text-lg font-semibold mt-6">3. PLATFORM USE</h3>
              <p><strong>3.1 License:</strong> MyPlug grants you a limited, non-exclusive, non-transferable license to use the
              ...
              <p><strong>3.3 Content Ownership:</strong> MyPlug retains all rights to its technology, content, recommendation
                engines, and interface. You may not use MyPlug's content for commercial purposes without prior
                written consent.</p>
              ...
              <p><strong>5.1 Order Process:</strong> You may purchase items directly through MyPlug or via vendor redirection. You
              ...
              <p><strong>5.3 MyPlug as Facilitator:</strong> In most cases, MyPlug acts only as a facilitator, not the seller. The
              ...
              <p><strong>5.5 Fees & Charges:</strong> MyPlug may charge a service fee, convenience fee, or include promotional
              ...
              <p><strong>6.1 Cancellation Policy:</strong> Cancellations may be allowed within a specific timeframe. Please
                check the vendor's terms or contact MyPlug support for help.</p>
              <p><strong>6.2 Returns & Refunds:</strong> Refunds are handled per the vendor's policy. If a product is defective,
                incorrect, or undelivered, MyPlug may assist in dispute resolution but is not liable for compensation
              ...
              <p><strong>9.1 Responsibility:</strong> You are responsible for maintaining the confidentiality of your account login
                details. MyPlug is not liable for unauthorized access resulting from negligence.</p>
              <p><strong>9.2 Termination:</strong> MyPlug reserves the right to suspend or terminate accounts that violate these
              ...
              <p><strong>10.2 MyPlug's total liability in any matter shall be limited to the value of the transaction in question
                or KES 5,000.</strong></p>

              <h3 className="text-lg font-semibold mt-6">11. DISPUTES & GOVERNING LAW</h3>
              <p><strong>11.1 Dispute Resolution:</strong> If you are dissatisfied, please first contact support@myplug.co.ke
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <p>
                These Terms and Conditions ("Agreement") govern the participation of vendors ("Vendor", "You", or "Your") on the MyPlug platform ("MyPlug", "we", "us", or "our"), operated by MyPlug Technologies Limited, a company registered in Kenya. By listing your products or services on MyPlug or engaging with the MyPlug team, you agree to abide by these Terms in full.
              </p>

              <h3 className="text-lg font-semibold mt-6">1. DEFINITIONS</h3>
              <p>
                "MyPlug Platform" – The AI-powered mobile and web platform, application interface, API systems, databases, and related services used by customers for smart shopping assistance.
              </p>
              <p>
                "Vendor Account" – The registered profile MyPlug creates or grants access to for managing listings and commercial activity.
              </p>
              <p>
                "Product" – Any goods, services, or offers listed by a Vendor.
              </p>
              <p>
                "Customer" – End-users or shoppers who use MyPlug to browse, compare, and purchase Products.
              </p>
              <p>
                "Commission" – A percentage fee retained by MyPlug from sales, unless otherwise negotiated.
              </p>
              <p>
    ...
    <Dialog open={showPrivacyDialog} onOpenChange={setShowPrivacyDialog}>
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Privacy policy for {userType === 'customer' ? 'customers' : 'vendors'} using the MyPlug platform.
          </DialogDescription>
        </DialogHeader>
