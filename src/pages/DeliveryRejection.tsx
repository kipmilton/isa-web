    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl text-red-600">Application Rejected</CardTitle>
          <CardDescription>
            Your delivery personnel application has been rejected
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              {deliveryProfile.admin_notes || 
                "Your application to become a delivery personnel has been rejected. Please contact support for more information."}
            </AlertDescription>
          </Alert>
...
export default DeliveryRejection; 